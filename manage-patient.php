...
<a href="edit-patient.php?editid=<?php echo $row['ID'];?>"><i class="fa fa-edit"></i>EDIT Patient</a> || <a href="view-patient.php?viewid=<?php echo $row['ID'];?>"><i class="fa fa-eye"></i>Full Details</a>
